 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.zooper.com/", wsdlLocation = "http://192.168.0.105:8989/ws/helloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://ws.zooper.com/", "HelloWSImplService");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://ws.zooper.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.zooper.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
